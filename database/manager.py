...
# Required imports
from shared_constants import TB_REGISTRATIONS_NAME, TbRegistrationsColumns, TB_REGISTRATIONS_ALL_COLUMNS

class DbManager:
    def __init__(self, mariadb_client: MariaDbClient):
        self.__mariadb_client = mariadb_client
        self.create_tb_registrations_if_not_exist()
